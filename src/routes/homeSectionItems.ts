...
router.post("/", async (req, res) => {
    try {
        ...
        */
        ...
        const lastItem =
            await prisma.homePageSectionItem.findFirst({
                where: {
        ...
        const startPosition =
            lastItem ? lastItem.position + 1 : 1;
...
/*
|--------------------------------------------------------------------------
| REORDER HOME PAGE SECTION ITEM POSITION
|--------------------------------------------------------------------------
*/
        ...
        */
        ...
        await prisma.$transaction(
            async (tx) => {
                ...
                |--------------------------------------------------------------------------
                |
                | Prevents unique constraint collision on:
                |
